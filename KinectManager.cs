...
//	public bool NearMode = false;
	...
	public void DetectGesture(uint UserId, KinectGestures.Gestures gesture)
	{
		...
		{					
			case KinectGestures.Gestures.Jump:
                ...
                gestureData.checkForGestures.Add(KinectGestures.Gestures.Walk);
                gestureData.checkForGestures.Add(KinectGestures.Gestures.Circle);
				break;
            ...
            case KinectGestures.Gestures.Circle:
                gestureData.checkForGestures.Add(KinectGestures.Gestures.Jump);
                gestureData.checkForGestures.Add(KinectGestures.Gestures.Squat);
                gestureData.checkForGestures.Add(KinectGestures.Gestures.Walk);
                break;
            ...
            case KinectGestures.Gestures.LeanLeft:
                gestureData.checkForGestures.Add(KinectGestures.Gestures.LeanRight);
                gestureData.checkForGestures.Add(KinectGestures.Gestures.Run);
                break;
            case KinectGestures.Gestures.LeanRight:
                gestureData.checkForGestures.Add(KinectGestures.Gestures.Run);
                gestureData.checkForGestures.Add(KinectGestures.Gestures.LeanLeft);
                break;
	...
	void Awake()
	{
		...
		if(CalibrationText != null)
		{
			CalibrationText.GetComponent<GUIText>().text = "偵測不到使用者，請調整距離!";
		}
							...
							if(GetGestureProgress(gestureData.userId, KinectGestures.Gestures.Click) < 0.3f)
							{
								if(HandCursor1 != null)
								{
									...
									if(HandCursor1.GetComponent<GUITexture>() == null)
									{
                                        ...
                                        vCursorPos.z = zDist;
										vCursorPos = Camera.main.ScreenToWorldPoint(vCursorPos);
									}

									HandCursor1.transform.position = Vector3.Lerp(HandCursor1.transform.position, vCursorPos, 5 * Time.deltaTime);
								}
								
								if(ControlMouseCursor)
								{
                                    Vector3 vCursorPos = HandCursor1.GetComponent<GUITexture>() != null ? HandCursor1.transform.position :
										Camera.main.ScreenToViewportPoint(HandCursor1.transform.position);
